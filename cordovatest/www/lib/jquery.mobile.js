...
* Git HEAD hash: 489cc6f22e5a650e044e7496bb079ae6b0772d69 <> Date: Wed Nov 27 2013 15:50:44 UTC
...
var keepNativeFactoryDefault = $.mobile.keepNative;
...
$.widget( "mobile.listview", $.extend( {
	...
	_beforeListviewRefresh: function( li ) {
		return li;
	},
	...
	refresh: function( create ) {
		...
		li = this._beforeListviewRefresh( this.element.children() );
...
$.widget( "mobile.listview", $.mobile.listview, {
	...
	_beforeListviewRefresh: function( li ) {
		if ( this.options.autodividers ) {
			li = this._replaceDividers( li );
		}
		return this._super( li );
	},

	_replaceDividers: function( lis ) {
		var i, li, dividerText,
		...
		for ( i = 0; i < lis.length ; i++ ) {
			li = lis[ i ];
			if ( $.mobile.getAttribute( li, "role" ) === "list-divider" ) {
				lis.splice( i--, 1 );
				this.element[ 0 ].removeChild( li );
			} else {
